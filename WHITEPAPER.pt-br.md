...
## 2. Engenharia de Materiais e Hardware

### 2.1 A Unidade "Aegis-Fractal"
...
### 2.2 Óptica Seletiva e Atmosférica
...
## 3. Navegação, Controle e Manufatura
...
### 3.2 Manufatura em Órbita (In-Space Assembly)
...
## 4. Estratégia Climática: "Soft Touch"

### 4.1 Gradientes Gaussianos (Feathering)
...
## 5. Governança, Ética e Segurança (Hard-Security)

### 5.1 Protocolo Lázaro (Human-in-the-Loop)
...
## 6. Análise de Impacto (Econômico e Científico)

### 6.1 Fotovoltaica (PV) vs. Termossolar (CSP)
...
### 6.2 Impacto na Astronomia Científica Terrestre
A rejeição seletiva de >95% da banda Infravermelha (NIR) impõe limitações à observação solar terrestre dedicada à magnetometria e espectropolarimetria (como o telescópio DKIST).
* **Interferência Conhecida:** O escudo atenuará os dados de instrumentação baseada em solo que dependem da banda NIR para estudar a coroa e manchas solares.
* **Medida Compensatória:** Para mitigar a perda de dados científicos, a **Rede Oracle (Ver Item 6.3)** será equipada com sensores de heliofísica voltados para o Sol (*Sun-facing sensors*), disponibilizando dados brutos de alta fidelidade em *Open Access* para a comunidade astronômica global, substituindo a necessidade de observação terrestre filtrada pela atmosfera.
...
## 8. O Legado: Projeto Argus-Panoptes
...
## 10. Referências Bibliográficas e Estudos Base
1.  **Conceito Original de Enxame L1:** *Angel, R. (2006).* "Feasibility of cooling the Earth with a cloud of small spacecraft near the inner Lagrange point (L1)". *PNAS*.
2.  **Dinâmica de Velas Solares:** *McInnes, C. R. (1999).* "Solar Sailing: Technology, Dynamics and Mission Applications".
3.  **Controle de Atitude sem Propelente:** *Negri, R.B. (2019).* "Attitude and Orbit Control of a Solar Sail Through Distributed Reflectivity Modulation Devices".
4.  **Impacto em Agricultura:** *Proctor, J., et al. (2018).* "Estimating the agricultural impacts of geoengineering". *Nature*.
